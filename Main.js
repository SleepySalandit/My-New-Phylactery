...
const insertx = ['hourglass with suspended :insertb: sand', 'leather book', ':inserty: pendant', ':inserta: skull', 'copper coin', 'a box lined with :insertb: velvet, containing your rotting heart'];
